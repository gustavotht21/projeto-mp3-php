<div class="row" style="color: #12376E;">
    <p class="w-xl-75 w-md-100 mt-5 fs-3" style="color: #12376E;">Com o Spotify aberto, clique no álbum que deseja salvar, clique em "Compartilhar álbum" e depois clique em "Incorporar álbum". Copie esse conteúdo e cole abaixo, e o link para o álbum será dado!</p>
    ...
    <form action="#" method="POST">
        ...
        <div>
            <button class="btn btn-success w-25" type="submit">Concluir</button>
